		...
		<section class="row">
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						<td>14:00 - 15:30</td>
						<td class="success">Be Careful What You Ask For: How Corporate Average Fuel Economy Incentivizing Alternative Fuel Vehicles Leads to Higher Carbon Emissions</td>
						<td class="warning">Reuse and Refurbishment Concept for Cost-Effective Treatment of Increasing Amounts of Defective Solar Modules</td>
						<td class="info">Improving Metropolitan Climate Action Planning by Incorporating Omissions and Quantifying Uncertainties</td>
					</tr>
					<tr>
						<td></td>
						<td class="success">Transit-oriented Smart Growth can Reduce Life-cycle Environmental Impacts and Household Energy and Travel Costs in Los Angeles</td>
						<td class="warning">Environmental trade-offs between utilizing recycled and virgin Tellurium for CdTe photovoltaic modules: Using anticipatory Life Cycle Assessment to analyze favorable pathways for future CdTe deployments</td>
						<td class="info">Building A Dynamic Multi-City, Regional GHG Emissions for the Phoenix Metropolitan Area</td>
					</tr>
					<tr>
						<td></td>
						<td class="success">A Comparison of Air Emissions from Natural Gas Pathways for Road Transportation</td>
						<td class="warning">GIS based environmental impact assessment of Photovoltaics in the Southeast region</td>
						<td class="info">The SuRe (Sustainable and Resilient) Zone of Urban Infrastructure System Planning & Design</td>
					</tr>
					<tr>
						<td></td>
						<td class="success">Global Demand Forecast for Precious Group Metals (PGM) in the Automobile Industry</td>
						<td class="warning">Design of Sustainable, Efficient, Safe and Economically Viable Solution for Solar Street Lighting System</td>
						<td class="info">Complementing Urban Metabolism with Life-cycle Assessment for Sustainable Communities: A Case Study of the Phoenix Transportation System</td>
					</tr>
					<tr>
						<td>15:30 - 16:00</td>
						<td colspan="3" class="text-center">
					...
					<tr>
						<td>16:00 - 17:30</td>
						<td class="success">Environmental tradeoffs and ethical dilemmas from increasing switchgrass biofuel production to meet current U.S. Renewable Fuel Standard and the CA low carbon biofuel standards</td>
						<td class="warning">Assessing Regional Differences in Lighting Heat Replacement Effects in Residential Buildings across the United States</td>
						<td class="info">Analysis of New Egyptian Cities Towards Sustainable Urban Metabolism</td>
					</tr>
					<tr>
						<td></td>
						<td class="success">Two-Stage Valorization of Cassava Processing Wastes into Biofuels</td>
						<td class="warning">Environmental and Economic Impacts of On-Site Renewable Energy for Buildings</td>
						<td class="info">How to make pre-chemicals out of municipal solid waste in an innovative, lucrative and environment-friendly way</td>
					</tr>
					<tr>
						<td></td>
						<td class="success">Quantifying the Carbon-Water-Energy Nexus for Drop-in Replacement Biofuels Produced from Perennial Grasses</td>
						<td class="warning">A Meta-Analysis of Research on Healthy Buildings and Employee Productivity</td>
						<td class="info">Identifying the scale and nexus of Carbon, Nitrogen and Biodiversity Impacts of Urban Systems.</td>
					</tr>
					<tr>
						<td></td>
						<td class="success">Greenhouse Gas Mitigation Benefits of Expanding U.S. Biofuel Incentives to Promote Biomass Use in Chemical Feedstocks</td>
						<td class="warning">Comparison of empirical and simulated models for residential electricity consumption</td>
						<td class="info">System Assessment of Water and Wastewater Services</td>
					</tr>
					<tr>
						<td>17:30 - 19:30</td>
						<td colspan="3" class="text-center">
					...
					<tr>
						<td>08:30 - 10:00</td>
						<td class="success">Assessing the Costs of Policies to Achieve Alternative Fuel Goals using State-level Modeling Methods</td>
						<td class="warning">Life Cycle Greenhouse Gas Implications of Exporting LNG to Meet China’s Growing Energy Demand</td>
						<td class="info">Society in Sustainability Transitions: Intersecting Life Cycle Assessment Results with Institutional Analysis as a Method for Achieving Sustainability Interventions</td>
					</tr>
					<tr>
						<td></td>
						<td class="success">Implications of market-mediated emissions and uncertainty for biofuel policies</td>
						<td class="warning">Life Cycle Assessment of the Use of Forest Biomass for Electricity</td>
						<td class="info">Understanding Sustainable Technology and Human Behaviour: Adolescence to Adulthood!</td>
					</tr>
					<tr>
						<td></td>
						<td class="success">Buying greener electronics: A global review of purchasing policies and practices</td>
						<td class="warning">Life Cycle Implications of Vehicle Lightweighting: A Case Study Based on a Physics-based Model</td>
						<td class="info">Variability and uncertainty in social cost estimates for air quality</td>
					</tr>
					<tr>
						<td></td>
						<td class="success">Factors Governing Change in Water Withdrawals for U.S. Industrial Sectors</td>
						<td class="warning">To be announced</td>
						<td class="info">Indirect Impacts of Renewable Penetration and the Growing Importance of Life Cycle Assessment</td>
					</tr>
					<tr>
						<td></td>
						<td class="success">Markets for used electronics parts, the missing component in the e-waste management systems.</td>
						<td class="warning">Environmental trade-offs of electric vehicle lithium-ion batteries with a cascading second life</td>
						<td class="info">Understanding the role of use phase on improving the environmental sustainability of pavements</td>
					</tr>
					<tr>
					...
					<tr>
						<td>8:30 - 10:00</td>
						<td class="success">Life-Cycle Inventory and Energy Analysis of FinFET Integrated Circuits</td>
						<td class="warning">Estimating the carbon balance of hydropower development in the Brazilian Legal Amazon</td>
						<td class="info">Measuring resilience through metrics: A comparative study of resilience metrics for complex systems</td>
					</tr>
					<tr>
						<td></td>
						<td class="success">Energy and carbon footprint performance metrics based on LCA in the ICT sector</td>
						<td class="warning">Land and Nutrient Reclamation and Optimization for Spatially-Informed Renewable Energy Production</td>
						<td class="info">Comparative Analysis of Sustainability Trends Determined by the Inclusive Wealth Index vs. Traditional Metrics</td>
					</tr>
					<tr>
						<td></td>
						<td class="success">Conflict minerals in the computer sector: Estimating the global use of Sn, Ta, W, Au in selected ICT products.</td>
